...
<div class="container space-y-4">
    ...
    <div class="row justify-between mx-0">
        ...
        <form method="GET" action="{{ route('pedidos.index') }}" class="flex flex-wrap items-center">
            <!-- Filtro por fecha -->
            ...
            <a href="{{ route('pedidos.index') }}" class="btn btn-secondary min-w-20 bg-gray-500 hover:bg-gray-600 text-white font-semibold py-2 px-3 rounded-lg block justify-center">Reiniciar</a>
        </form>

        <form method="GET" action="{{ route('pedidos.index') }}" class="flex items-center">
            ...
            <button type="submit" class="btn btn-primary min-w-20 text-center bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-3 rounded-lg">Buscar</button>
        </form>
