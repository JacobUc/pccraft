...
<div class="container mx-auto mt-6 mb-6 w-full lg:w-2/3">
    ...
    <nav aria-label="breadcrumb" class="mb-8">
        <ol class="breadcrumb flex space-x-2">
            ...
            <li class="breadcrumb-item active text-2xl font-medium text-gray-900 dark:text-white" aria-current="page">Carrito</li>
        </ol>
    </nav>


    @if (session()->has('success_msg'))
    <div id="alert-3" class="flex items-center  px-4 py-3 mb-6 text-green-800 rounded-lg bg-green-200 dark:bg-gray-800 dark:text-green-400" role="alert">
    ...
    <div id="alert-3" class="flex items-center px-4 py-3 mb-6 text-red-800 rounded-lg bg-red-200 dark:bg-gray-800 dark:text-red-400" role="alert">
        <span class="sr-only">Error</span>
        <div class="ms-3 text-sm font-medium">
            <strong>{{ session()->get('errors')->first() }}</strong>
        </div>
        <button type="button" class="ms-auto -mx-1.5 -my-1.5 bg-red-70 text-red-500 rounded-lg focus:ring-2 focus:ring-red-400 p-1.5 hover:bg-red-200 inline-flex items-center justify-center h-8 w-8 dark:bg-gray-800 dark:text-red-400 dark:hover:bg-gray-700" data-dismiss-target="#alert-3" aria-label="Close">
            <span class="sr-only">Close</span>
            <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
            </svg>
